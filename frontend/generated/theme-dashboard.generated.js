...
import stylesCss from 'themes/dashboard/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_dashboard_componentCss']) {
    
    document['_vaadintheme_dashboard_componentCss'] = true;
  }

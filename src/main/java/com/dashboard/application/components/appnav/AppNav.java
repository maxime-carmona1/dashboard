package com.dashboard.application.components.appnav;
...
public class AppNav extends Component implements HasSize, HasStyle {
     ...
     * Permettez à l'utilisateur final effondrer / masquer et développer / afficher les éléments de navigation.
     * <p>
     * NOTE: The navigation has to have a label for it to be collapsible.
     *
     * @param collapsible

import {
  ConnectionIndicator,
  ConnectionState
} from "./chunk-7A4WD7EH.js";
import "./chunk-V7ATHVVB.js";
...
var Flow = class {
  ...
  async flowInit(serverSideRouting = false) {
    if (!this.isFlowClientLoaded()) {
      ...
      const bootstrapMod = await import("./FlowBootstrap-GWIC42C3.js");
      await bootstrapMod.init(this.response);
      if (typeof this.config.imports === "function") {
        this.injectAppIdScript(appId);
        await this.config.imports();
      }
      const clientMod = await import("./FlowClient-AWKV4KO6.js");
